...
export default {
  ...
  extends: SymmetryAnalysis, // inherit from sym-analysis Component, need to rewrite analysis request method as bellow, as well as the page of step 3 to present result
  methods: {
